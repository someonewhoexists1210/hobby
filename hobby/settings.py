...
SECRET_KEY = 'django-insecure-gtxk2(^*=rtn69aoh1%09o+iibi^8l72u*t*u%ca0hci59x@lw'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR_STR, 'front', 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR_STR, 'front', 'static')]
